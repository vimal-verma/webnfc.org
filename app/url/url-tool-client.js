...
export default function UrlToolClient() {
    ...
    const handleDownloadQR = (isStylish = false) => {
        ...
        if (!isStylish) {
            ...
            triggerDownload(pngUrl, `url_webnfc.org_qr.png`);
        ...
        const drawContentAndDownload = (bgImage = null) => {
            ...
            triggerDownload(pngUrl, `url_stylish_webnfc.org_qr.png`);
                    ...
                    {isQrEditorExpanded && (
                        <div id="qr-editor-section" className={styles.qrEditor} aria-describedby="qr-editor-note">
                            ...
                            <div className={styles.inputGroup}>
                                ...
                                <input id="stylishText" type="text" value={stylishText} onChange={(e) => setStylishText(e.target.value)} placeholder="e.g., Scan to Visit" />
                            </div>
                            <div className={styles.inputGroup}>
                            ...
                            <button onClick={() => handleDownloadQR(true)} disabled={!url} className={styles.stylishDownloadButton}>
                                Download Stylish QR
                            </button>
