...
export default function CallToolClient() {
    ...
    const handleDownloadQR = (isStylish = false) => {
        ...
        if (!isStylish) {
            ...
            triggerDownload(pngUrl, `${phoneNumber || 'call'}_webnfc.org_qr.png`);
        ...
        const drawContentAndDownload = (bgImage = null) => {
            ...
            triggerDownload(pngUrl, `${phoneNumber || 'call'}_stylish_webnfc.org_qr.png`);
                    ...
                    {isQrEditorExpanded && (
                        <div id="qr-editor-section" className={styles.qrEditor} aria-describedby="qr-editor-note">
                            ...
                            <div className={styles.inputGroup}>
                                ...
                                <input id="stylishText" type="text" value={stylishText} onChange={(e) => setStylishText(e.target.value)} placeholder="e.g., Scan to Call" />
                            </div>
                            <div className={styles.inputGroup}>
                            ...
                            <button onClick={() => handleDownloadQR(true)} disabled={!callUrl} className={styles.stylishDownloadButton}>
                                Download Stylish QR
                            </button>
