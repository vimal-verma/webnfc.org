...
export default function LocationToolClient() {
    ...
    }, [latitude, longitude, qrFgColor, qrBgColor, qrLogo, qrLogoSize, stylishText, stylishTextColor]);
    ...
    const handleWriteNfc = async () => {
        if (!locationUrl) {
            addToLog('Please fill in Latitude and Longitude first.', 'error');
            return;
        }
        ...
        try {
            ...
            await ndef.write({
                records: [{ recordType: "url", data: locationUrl }]
            });

            addToLog(`✅ Successfully wrote Location link to NFC tag!`, 'success');
            addToLog(`Data Written: ${locationUrl}`, 'info');
    ...
    const handleDownloadQR = (isStylish = false) => {
        ...
        if (!isStylish) {
            ...
            triggerDownload(pngUrl, `location_${latitude}_${longitude}_webnfc.org_qr.png`);
        ...
        const drawContentAndDownload = (bgImage = null) => {
            ...
            triggerDownload(pngUrl, `location_${latitude}_${longitude}_stylish_webnfc.org_qr.png`);
    ...
    const handleCopyLink = () => {
        ...
        navigator.clipboard.writeText(locationUrl).then(() => {
            addToLog('✅ Geo link copied to clipboard!', 'success');
        }, () => {
            addToLog('Failed to copy Geo link.', 'error');
        });
    };
                ...
                <div className={styles.form}>
                    ...
                    {isQrEditorExpanded && (
                        <div id="qr-editor-section" className={styles.qrEditor} aria-describedby="qr-editor-note">
                            ...
                            <button onClick={() => handleDownloadQR(true)} disabled={!locationUrl} className={styles.stylishDownloadButton}>
                                Download Stylish QR
                            </button>
                ...
                <div className={styles.output}>
                    ...
                    <div className={styles.buttonGroup}>
                        <button
                            ...
                            disabled={isWriting || !locationUrl}
                        ...
                        <button
                            onClick={() => window.open(locationUrl, '_self')}
                            disabled={!locationUrl}
                            className={styles.copyButton}
                        >
                            Open Geo Link
